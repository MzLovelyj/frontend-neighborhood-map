...
Final project for Udacity's Front End Course. Build a Rect App From Scratch. The App is supose to have a list of Resturants but I decided to do Breweries in Miami, Fl instead. Since Ya girl Loves Beer and craft beer is part of the Miami Scene! https://mzlovelyj.github.io/frontend-neighborhood-map/
